...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    preference :system_wide_notifications, :string, :default => '' # will used to configure home pages product rotator
    preference :no_of_seconds, :integer# will used to configure home pages product rotator
    preference :check_for_vacation_mode_on, :boolean, :default => false # will used to configure home pages product rotator
