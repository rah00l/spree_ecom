...
#    after_initialize :user_build_bill_address
    attr_accessible :set_no_shipping_charges,:set_no_sales_tax,:user_group_id,:bill_address,:bill_address_attributes,:referral_source_id,:other_referral,:bill_address_id,:newsletter
...
#      self.build_bill_address if self.new_record?
#    end
