...
#      raise self.user.set_no_sales_tax.inspect
      unless self.user.set_no_sales_tax
    ...
    def create_shipment!
      #      raise self.user.set_no_shipping_charges?.inspect
      unless self.user.set_no_shipping_charges
